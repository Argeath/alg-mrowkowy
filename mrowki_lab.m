...
liczba_tras = 100;             % liczba tras wyznaczanych przez mrowki
liczba_krokow_max = 70;        % maksymalna liczba krokow, by zabezpieczyc sie przed petla
...
for trasa=1:liczba_tras
    ...
    while (krok < liczba_krokow_max)&&((pole(1) ~= meta(1))||(pole(2) ~= meta(2)))
        ...
        if liczba_dostepnych == 0
            ...
            if sum(ilosci_fer) == 0
                ind_pola_wybr = randi(liczba_dost);
            else
              ilosci_feromonu_do_n = ilosci_feromonu .^ n;
              indeksy = 1:liczba_dost;
              wagi = ilosci_feromonu_do_n ./ sum(ilosci_feromonu_do_n);
              ind_pola_wybr = randsample(indeksy, 1, true, wagi);
            end
            % .........................................................
    ...
    if (pole(1) == meta(1))&&(pole(2) == meta(2))  % jesli koncowym polem jest meta
        ...
        for i=1:length(sciezka(:,1))
            f_swiezy(sciezka(i,1),sciezka(i,2)) = 1/length(sciezka(:,1));
        end
        % ..........................................................
    end
    ...
    if sledzenie
        f_rys = (1-f/max(max(f))*0.94).*t;     % przygotowanie rysunku (by bylo widac sciany labiryntu i feromon
